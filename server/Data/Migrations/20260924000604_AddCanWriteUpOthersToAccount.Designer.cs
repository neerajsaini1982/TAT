...
namespace Server.Data.Migrations
{
    ...
    [Migration("20260924000604_AddCanWriteUpOthersToAccount")]
    partial class AddCanWriteUpOthersToAccount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Models.Account", b =>
                {
                    ...
                    b.Property<bool>("CanWriteUpOthers")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Server.Models.AllowedPunchDevice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("LocationId", "IpAddress")
                        .IsUnique();

                    b.ToTable("AllowedPunchDevices");
                });
            ...
            modelBuilder.Entity("Server.Models.EmployeeDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Server.Models.EmploymentPeriod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Server.Models.LocationSettings", b =>
                {
                    ...
                    b.Property<bool>("AdminSeesAllSchedules")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("ClockInAnywhere")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("LeadSeesAllSchedules")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Server.Models.TimeEntry", b =>
                {
                    ...
                    b.Property<DateTime?>("LeftEarlyMarkedAt")
                        .HasColumnType("TEXT");

                    b.Property<int?>("LeftEarlyMarkedByAccountId")
                        .HasColumnType("INTEGER");

                    b.Property<string>("LeftEarlyNote")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("LeftEarlyMarkedByAccountId");
            ...
            modelBuilder.Entity("Server.Models.EmployeeDocument", b =>
                {
                    ...
                    b.HasOne("Server.Models.Account", "UploadedByAccount")
                        .WithMany()
            ...
            modelBuilder.Entity("Server.Models.TimeEntry", b =>
                {
                    ...
                    b.HasOne("Server.Models.Account", "LeftEarlyMarkedByAccount")
                        .WithMany()
                        .HasForeignKey("LeftEarlyMarkedByAccountId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("LeftEarlyMarkedByAccount");
